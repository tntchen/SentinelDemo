package com.nflow.sentinel.web;
...
public class DemoController {
    ...
    @GetMapping("/get")
    public DemoDto get(@RequestParam("id") Integer id) {
        return demoService.getDemo(id.longValue());
    }
    ...
    @GetMapping("/httpDemo")
    public String httpDemo() throws InterruptedException, IOException {
        return demoService.httpDemo();
    }
}